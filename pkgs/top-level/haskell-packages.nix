...

{
  ...
  Cabal_1_22_1_1 = callPackage ../development/libraries/haskell/Cabal/1.22.1.1.nix {};
  ...
  cabalInstall_1_22_0_1 = callPackage ../tools/package-management/cabal-install/1.22.0.1.nix { Cabal = self.Cabal_1_22_1_1; };
