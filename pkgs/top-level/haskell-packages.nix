...

{
  ...
  Cabal_1_22_2_0 = callPackage ../development/libraries/haskell/Cabal/1.22.2.0.nix {};
  ...
  cabalInstall_1_22_2_0 = callPackage ../tools/package-management/cabal-install/1.22.2.0.nix { Cabal = self.Cabal_1_22_2_0; };
