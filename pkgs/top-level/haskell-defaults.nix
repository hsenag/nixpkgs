...
{ makeOverridable, lowPrio, hiPrio, stdenv, pkgs, newScope, config, callPackage } : rec {
  ...
  ghc783Prefs = self : super : ghcHEADPrefs self super // {
    cabalInstall_1_20_0_4 = super.cabalInstall_1_20_0_4.override { Cabal = self.Cabal_1_20_0_3; };
    codex = super.codex.override { hackageDb = super.hackageDb.override { Cabal = self.Cabal_1_20_0_3; }; };
    MonadRandom = self.MonadRandom_0_1_13; # newer versions require transformers >= 0.4.x
    mtl = self.mtl_2_1_2;
  };
